...
function init() {
  ...
  const width=document.getElementById('canvas1').clientWidth;
  const height=document.getElementById('canvas1').clientHeight;
  ...
  const url = 'https://raw.githubusercontent.com/kamuYasiro/model-test/main/stand-light.gltf';
